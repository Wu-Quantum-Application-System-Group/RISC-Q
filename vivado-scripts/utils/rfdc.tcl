...
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC1_AXIS] [get_bd_intf_pins rf_data_converter/s01_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC2_AXIS] [get_bd_intf_pins rf_data_converter/s02_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC3_AXIS] [get_bd_intf_pins rf_data_converter/s03_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC4_AXIS] [get_bd_intf_pins rf_data_converter/s10_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC5_AXIS] [get_bd_intf_pins rf_data_converter/s11_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC6_AXIS] [get_bd_intf_pins rf_data_converter/s12_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC7_AXIS] [get_bd_intf_pins rf_data_converter/s13_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC8_AXIS] [get_bd_intf_pins rf_data_converter/s20_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC9_AXIS] [get_bd_intf_pins rf_data_converter/s21_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC10_AXIS] [get_bd_intf_pins rf_data_converter/s22_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC11_AXIS] [get_bd_intf_pins rf_data_converter/s23_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC12_AXIS] [get_bd_intf_pins rf_data_converter/s30_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC13_AXIS] [get_bd_intf_pins rf_data_converter/s31_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC14_AXIS] [get_bd_intf_pins rf_data_converter/s32_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/DAC15_AXIS] [get_bd_intf_pins rf_data_converter/s33_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC0_AXIS] [get_bd_intf_pins rf_data_converter/m00_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC1_AXIS] [get_bd_intf_pins rf_data_converter/m01_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC2_AXIS] [get_bd_intf_pins rf_data_converter/m02_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC3_AXIS] [get_bd_intf_pins rf_data_converter/m03_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC4_AXIS] [get_bd_intf_pins rf_data_converter/m10_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC5_AXIS] [get_bd_intf_pins rf_data_converter/m11_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC6_AXIS] [get_bd_intf_pins rf_data_converter/m12_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC7_AXIS] [get_bd_intf_pins rf_data_converter/m13_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC8_AXIS] [get_bd_intf_pins rf_data_converter/m20_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC9_AXIS] [get_bd_intf_pins rf_data_converter/m21_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC10_AXIS] [get_bd_intf_pins rf_data_converter/m22_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC11_AXIS] [get_bd_intf_pins rf_data_converter/m23_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC12_AXIS] [get_bd_intf_pins rf_data_converter/m30_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC13_AXIS] [get_bd_intf_pins rf_data_converter/m31_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC14_AXIS] [get_bd_intf_pins rf_data_converter/m32_axis]
connect_bd_intf_net [get_bd_intf_pins ${TOP}/ADC15_AXIS] [get_bd_intf_pins rf_data_converter/m33_axis]
